...
/**
 * Class extending the {@link Reducer} class in Hadoop and enabling it to start a nested job.
 * 
...
public class NestedReducer<KEYIN, VALUEIN, KEYOUT, VALUEOUT> extends Reducer<KEYIN, VALUEIN, KEYOUT, VALUEOUT>{
	...
	/**
	 * This class defines the internal workflow of the NestedReducer it uses the context from the default {@link Reducer}.
	 * 
	 * @param context Uses the {@link Reducer.Context} of default Hadoop Reducer.
	 ...
	 * @param context The {@link Context} of the default Hadoop {@link Reducer}
	 * @throws IOException
	...
	/**
	 * Configures the nestedReducer user provided function and writes it's results to an intermediate file.
	 * @param context The default {@link Context} of the Hadoop {@link Reducer}.
	 * @throws IOException
	 * @throws InterruptedException
	 * @throws ClassNotFoundException
	 * @throws InstantiationException
	...
	/**
	 * Gets the key/value pairs ready for the nested job.
	...
	/**
	 * Sets up the normalReducer function and feeds it the output of the nested job.
	 * @param context Uses the {@link Context} of the {@link Reducer} to write the key/value pairs to disk.
	 * @throws Exception
	 */
